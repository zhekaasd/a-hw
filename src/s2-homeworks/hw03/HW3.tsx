...
export const pureAddUserCallback = (name: string, setUsers: (array: UserType[]) => void, users: UserType[]) => { // need to fix any
    const user = { // need to fix
        name: name,
        _id: Math.floor(Math.random() * 100000 + Math.random() * 10)
    }
    setUsers([...users, user]);
}
...
const HW3 = () => {
    ...
    return (
        <div style={{position: 'relative'}} id={'hw3'}>
